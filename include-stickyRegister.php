...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <form action="registerUser.php" method="POST">
      <?php echo $errorMsg; ?>
      <p>Please enter your full name: Name: <input type="text" name="name" value="<?php echo $name; ?>"/>
         Surname: <input type="text" name="surname" value="<?php echo $surname; ?>"/>
      </p>
      <p>Please enter your phone number: <input type="text" name="phone" size="8" value="<?php echo $phone; ?>"/></p>
      <p>Please enter your email: <input type="text" name="email" value="<?php echo $email; ?>"/></p>
